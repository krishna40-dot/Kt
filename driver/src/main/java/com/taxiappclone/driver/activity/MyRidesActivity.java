...
import com.taxiappclone.driver.adapter.MyRidesListAdapter;
...
public class MyRidesActivity extends CustomActivity {
    ...
    private void getCollectionFromServer() {
        ...
        apiService.getRidesDriver(requestBody, session.getStringValue("auth_token")).enqueue(new Callback<MyRidesResponse>() {
            @Override
