...
public class StoredLocationsActivity extends CustomActivity {
    ...
    private void getAllStoredLocations() {
        ...
        apiService.getDriverAddress(requestBody).enqueue(new Callback<RiderAddressResponse>() {
            @Override
                ...
                listAdapter = new StoredLocationsListAdapter(StoredLocationsActivity.this, riderAddresses) {
                    ...
                    public void delete(RiderAddress riderAddress) {
                        ...
                        RequestBody requestBody = new MultipartBody.Builder()
                                ...
                                .build();
                        apiService.deleteDriverAddress(requestBody).enqueue(new Callback<JSONObject>() {
                            @Override
